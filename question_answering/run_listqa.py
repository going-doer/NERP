...
from utils_qa import transform_n2b_listqa, eval_bioasq_standard
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    ## Transform thed prediction into the BioASQ format
    logger.info("***** Transform the prediction file into the BioASQ format {} *****".format(prefix))
    transform_n2b_listqa(output_nbest_file, args.output_dir)
    ...
    print("** BioASQ-list Evaluation Results ************************************")
    print(f"   List Precision   = {float(eval_score[4])*100:.2f}")
    print(f"   List Recall      = {float(eval_score[5])*100:.2f}")
    print(f"   List F1          = {float(eval_score[6])*100:.2f}")
